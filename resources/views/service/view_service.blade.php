    ...
    <div class="col-md-12 col-sm-12">
        <div class="card">
            <div class="header-container d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('service.create') }}" class="btn btn-sm mt-1 button">
                    <i class="bi bi-plus-lg mr-5" style="margin-right: 5px"></i> Add Service
                </a>
            </div>
            <hr>
                        ...
                        <tbody>
                            @foreach ($services as $index => $service)
                                <tr class="">
                                    ...
                                    <td class="text-center"><img src="{{ asset('images/' . $service->image) }}"
