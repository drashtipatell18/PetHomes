...
<section class="ProductDataContainer ">
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasRes" aria-labelledby="offcanvasExampleLabel">
        ...
        <div class="offcanvas-body">
            ...
            <a class="clear" href="" id="a_pet1">Pet Accessories</a>
            <div class="filterDataContainer">
                <div class="filterData">
                    <h4 class="filterParameter">Type of Listing</h4>
                    <div class="filterParameterVariations ">
    ...
    <div class="allProducts">
        <div class="sortContainer">
            ...
            <div class="m_prTitl">
                <h3 id="pet_sal">Pet Accessories for Sale</h3>
                <p id="pet_itme">{{count($services)}} Accessories For Sale</p>
            </div>
            <div class="sort">
        ...
        <div class="m_prTitl2">
            <h3 class="mb-0" id="pet_sal1">Pet Accessories for Sale</h3>
            <p id="pet_itme1">{{count($services)}} Acessories For Sale</p>
        </div>
        <div class="productContainer row" id="displayPet">

            @foreach ($services as $service)
            <a data-breed="{{$service->name}}" class="ProductWrapper p1 col-sm-6 col-lg-4" href="/viewservice/{{$service->id}}">
                <div class="product">
                    <i class="fa-regular fa-heart m_wishIc"></i>
                    <div class="productImage">
                        <img src="/images/{{$service->image}}" class="d-block w-100" alt="...">
                    </div>
