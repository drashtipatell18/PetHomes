    ...
    <div class="allProducts">
        <div class="sortContainer">
            ...
            <div class="m_prTitl">
                ...
                <p id="pet_itme">{{count($products)}} Accessories For Sale</p>
            </div>
            <div class="sort">
        ...
        <div class="m_prTitl2">
            ...
            <p id="pet_itme1">{{count($products)}} Acessories For Sale</p>
        </div>
        <div class="productContainer row" id="displayPet">

            @foreach ($products as $product)
            <a data-breed="{{$product->name}}" class="ProductWrapper p1 col-sm-6 col-lg-4" href="/viewproduct/{{$product->id}}">
                <div class="product">
