    ...
    <div class="col-md-12 col-sm-12">
        <div class="card">
            <div class="header-container d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('product.create') }}" class="btn btn-sm mt-1 button">
                    <i class="bi bi-plus-lg mr-5" style="margin-right: 5px"></i> Add Product
                </a>
            </div>
            <hr>
                        ...
                        <tbody>
                            @foreach ($products as $index => $product)
                                <tr class="">
                                    ...
                                    <td class="text-center"><img src="{{ asset('images/' . $product->image) }}"
