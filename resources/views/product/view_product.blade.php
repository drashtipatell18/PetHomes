...
<div class="col-md-12 col-sm-12">
    <div class="card">
        <div class="card-header py-3">Product List</div>
        <hr>
        <div class="card-body py-3">
            <div class="card-title">
                ...
                <div class="button-container text-right mb-2">
                    <a href="{{ route('product.create') }}" class="btn btn-info btn-sm mt-1">
                ...
                <table class="table table-sm table-specing" id="myTable">
                    ...
                    <tbody>
                        ...
                        <tr class="">
                            ...
                            <td class="text-center"><img src="{{ asset('images/' .$product->image)}}" class="img-fixed-height" width="100px"></td>
