    ...
    <div class="col-md-12 col-sm-12">
        <div class="card">
            <div class="header-container d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('chat.create') }}" class="btn btn-sm mt-1 button">
                    <i class="bi bi-plus-lg mr-5" style="margin-right: 5px"></i> Add Chat
                </a>
            </div>
            <hr>
                            ...
                            @foreach ($chats as $index => $chat)
                                <tr class="">
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('edit.chat', $chat->id) }}" class="button btn-sm"><i
                                                class="bi bi-pencil-square"></i></a>

                                        <a href="{{ route('destroy.chat', $chat->id) }}"
