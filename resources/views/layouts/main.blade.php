...
<style>
    ...
    /* Ensure the content area has enough bottom padding to prevent overlap with footer */
    #content {
        padding-bottom: 80px;
        /* Adjust this value based on your footer's height */
    }

    /* Ensure the main wrapper has a minimum height for short pages */
    .mimin-wrapper {
        min-height: 100vh;
        position: relative;
        padding-bottom: 60px;
    ...
    <div class="container-fluid mimin-wrapper">
            ...
            <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="active ripple">
                        <a class="tree-toggle nav-header" href="{{ route('dashboard') }}"><span
                                class="fa-home fa"></span> Dashboard
                        </a>
                    </li>
                    <li class="ripple">
                    ...
                    <li class="ripple"><a class="tree-toggle nav-header"><span class="fa fa-check-square-o"></span>
                            Forms <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                        <ul class="nav nav-list tree">
                    ...
                    <li class="ripple"><a class="tree-toggle nav-header"><span class="fa fa-table"></span> Tables
                    ...
                    <li class="ripple"><a href="calendar.html"><span class="fa fa-calendar-o"></span>Calendar</a>
                    </li>
                    <li class="ripple"><a class="tree-toggle nav-header"><span class="fa fa-envelope-o"></span> Mail
                            <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                        <ul class="nav nav-list tree">
                    ...
                    <li class="ripple"><a class="tree-toggle nav-header"><span class="fa fa-file-code-o"></span>
                            Pages <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                        <ul class="nav nav-list tree">
                    ...
                    <li class="ripple"><a class="tree-toggle nav-header"><span class="fa "></span> MultiLevel
                            <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                        <ul class="nav nav-list tree">
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <p>&copy; 2024 Miminium. All rights reserved.</p>
                    </div>
